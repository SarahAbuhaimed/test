...
export  class NXMCall {
   ...
   * @param {string} type the type of the call you want to have. possible values "phone" or "app" ( is "phone")
     ...
     * @private
    */
    createServerCall(user: string, type?: string): Promise<MediaStream>;
    /**
...
export  class RtcHelper {
    ...
    */
    ...
    static sendOffer(application: Application, pc: RTCPeerConnection, conversation: Conversation): {
        rtc_id: string;
    };
    ...
    static _initStatsEvents(application: Application, call: NXMCall): RTCStats;
    static enableCallStats(context: MediaHandlerContext): void;
    static attachConversationEventHandlers(context: MediaHandlerContext): void;
    static onconnectionstatechangeHandler: (pc: RTCPeerConnection, log: Logger, resolveCallback: any, rejectCallback: any) => void;
    ...
    static prewarmLeg(application: Application): Promise<PrewarmResponse>;
}
