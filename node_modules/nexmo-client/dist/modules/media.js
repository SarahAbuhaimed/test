...
class Media {
    constructor(conversationOrApplication) {
        ...
        if (conversation) {
            ...
            this.rtcstats_conf = {};
            this.rtcStats = null;
            if (this.application.session.config &&
                this.application.session.config.rtcstats) {
                this.rtcstats_conf = {
     ...
     */
    _enableCallStats() {
        const { application, pc, parentConversation: conversation } = this;
        const context = {
            application,
            conversation,
            pc
        };
        rtc_helper_1.default.enableCallStats(context);
    }
    /**
    ...
    _handleAudio(params = {}) {
        return new Promise(async (resolve, reject) => {
            ...
            this.streamIndex++;
            const localStream = await rtc_helper_1.default.getUserAudio(params.audioConstraints);
